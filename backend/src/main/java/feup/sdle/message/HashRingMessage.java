  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        HashRing.class.getName());
    }
    // Use HashRing.newBuilder() to construct.
    private HashRing(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private HashRing() {
    }
...
feup.sdle.message.NodeIdentifierMessage.NodeIdentifier defaultValue) {
    ...
    public static final class Builder extends
      ...
      private static final class NodesConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier> {
        @java.lang.Override
        public feup.sdle.message.NodeIdentifierMessage.NodeIdentifier build(feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder val) {
          if (val instanceof feup.sdle.message.NodeIdentifierMessage.NodeIdentifier) { return (feup.sdle.message.NodeIdentifierMessage.NodeIdentifier) val; }
          return ((feup.sdle.message.NodeIdentifierMessage.NodeIdentifier.Builder) val).build();
        }

        @java.lang.Override
        public com.google.protobuf.MapEntry<java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier> defaultEntry() {
      ...
      private com.google.protobuf.MapFieldBuilder<
          java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier.Builder> nodes_;
      private com.google.protobuf.MapFieldBuilder<java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier.Builder>
          internalGetNodes() {
        if (nodes_ == null) {
...
feup.sdle.message.NodeIdentifierMessage.NodeIdentifier defaultValue) {
        if (key == null) { throw new NullPointerException("map key"); }
        java.util.Map<java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder> map = internalGetMutableNodes().ensureBuilderMap();
      ...
      public Builder putAllNodes(
        ...
        for (java.util.Map.Entry<java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifier> e : values.entrySet()) {
       ...
       * <code>map&lt;string, .feup.sdle.message.NodeIdentifier&gt; nodes = 1;</code>
       */
      public feup.sdle.message.NodeIdentifierMessage.NodeIdentifier.Builder putNodesBuilderIfAbsent(
          java.lang.String key) {
        java.util.Map<java.lang.String, feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder> builderMap = internalGetMutableNodes().ensureBuilderMap();
        feup.sdle.message.NodeIdentifierMessage.NodeIdentifierOrBuilder entry = builderMap.get(key);
        if (entry == null) {
          entry = feup.sdle.message.NodeIdentifierMessage.NodeIdentifier.newBuilder();
          builderMap.put(key, entry);
        }
        if (entry instanceof feup.sdle.message.NodeIdentifierMessage.NodeIdentifier) {
          entry = ((feup.sdle.message.NodeIdentifierMessage.NodeIdentifier) entry).toBuilder();
          builderMap.put(key, entry);
        }
        return (feup.sdle.message.NodeIdentifierMessage.NodeIdentifier.Builder) entry;
      }
