...
public class ShoppingList implements Document {
    ...
    private HashMap<String, DottedValue<Integer, Integer, ShoppingListItem>> removedCounters;
    ...
    public void remove(String key) {
        ...
        this.removedCounters.put(key, item);
      ...
      *
      * For example, if someone removes the item with the original value 1 but the other one adds 2 to the quantity, the item should remain with value 1.
      */
    public void merge() {
